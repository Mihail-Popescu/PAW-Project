    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActiveServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveService", x => x.ActiveServiceId);
                    table.ForeignKey(
                        name: "FK_ActiveService_OrderItem_OrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActiveService_OrderItemId",
                table: "ActiveService",
                column: "OrderItemId");
